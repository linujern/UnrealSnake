...
{
	struct SnakePawn_eventRotateSnake_Parms
	{
		ESnakeDirection InDirection;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::NewProp_InDirection_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::NewProp_InDirection = { "InDirection", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(SnakePawn_eventRotateSnake_Parms, InDirection), Z_Construct_UEnum_SnakeGame_ESnakeDirection, METADATA_PARAMS(0, nullptr) }; // 214707847
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::NewProp_InDirection_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::NewProp_InDirection,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASnakePawn, nullptr, "RotateSnake", nullptr, nullptr, Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::PropPointers), sizeof(Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::SnakePawn_eventRotateSnake_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00080401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ASnakePawn_RotateSnake_Statics::SnakePawn_eventRotateSnake_Parms) < MAX_uint16);
...
DEFINE_FUNCTION(ASnakePawn::execRotateSnake)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->RotateSnake(ESnakeDirection(Z_Param_InDirection));
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_ASnakePawn_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SnakePlayerState_MetaData[] = {
		{ "Category", "SnakePawn" },
		{ "ModuleRelativePath", "SnakePawn.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_SnakePlayerState;
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASnakePawn_RotateSnake, "RotateSnake" }, // 1020154535
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASnakePawn_Statics::NewProp_SnakePlayerState = { "SnakePlayerState", nullptr, (EPropertyFlags)0x0020080000020015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASnakePawn, SnakePlayerState), Z_Construct_UClass_ASnakePlayerState_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SnakePlayerState_MetaData), NewProp_SnakePlayerState_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASnakePawn_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASnakePawn_Statics::NewProp_SnakePlayerState,
...
struct Z_CompiledInDeferFile_FID_Users_Linus_Jernstrom_Documents_GitHub_UnrealSnake_SnakeGame_Source_SnakeGame_SnakePawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASnakePawn, ASnakePawn::StaticClass, TEXT("ASnakePawn"), &Z_Registration_Info_UClass_ASnakePawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASnakePawn), 864589558U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Linus_Jernstrom_Documents_GitHub_UnrealSnake_SnakeGame_Source_SnakeGame_SnakePawn_h_3182866292(TEXT("/Script/SnakeGame"),
